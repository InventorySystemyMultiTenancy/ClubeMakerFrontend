 ...
 * Exemplo: clube-joao.clubsmaker.com.br -> storeId: "clube-joao"
 *
 * PRIORIDADE:
 * 1. Variável de ambiente (VITE_DEFAULT_STORE_ID) - MÁXIMA PRIORIDADE
 * 2. Subdomínio (exceto 'www')
 * 3. Fallback padrao (clubsmaker_01)
 */

// SINGLE-TENANT: Defina o ID da loja única aqui ou via .env
const DEFAULT_STORE_ID = import.meta.env.VITE_DEFAULT_STORE_ID || "clubsmaker_01";
