...
Seja direto e focado em ações práticas. Use emojis para deixar mais visual.`;
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-[var(--color-primary-active)] mb-2">
          📊 Recomendações IA
        </h1>
      ...
      <div className="mb-8">
        <button
          ...
          className="bg-[var(--color-primary)] text-white font-bold py-3 px-8 rounded-lg hover:bg-[var(--color-primary-active)] transition-colors disabled:bg-[var(--color-primary-light)] disabled:cursor-not-allowed"
        >
      ...
      {recommendation && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-[var(--color-primary-lighter)] to-[var(--color-primary-light)] p-6 rounded-xl shadow-lg border-l-4 border-[var(--color-primary)]">
              <h3 className="text-sm font-semibold text-[var(--color-primary-active)] mb-2">
                📦 Total de Pedidos
              </h3>
              <p className="text-3xl font-bold text-[var(--color-primary-active)]">
                {orders.length}
              </p>
              <p className="text-sm text-[var(--color-primary)] mt-2">Últimos 30 dias</p>
            </div>

            <div className="bg-gradient-to-br from-[var(--color-accent)]/10 to-[var(--color-accent)]/20 p-6 rounded-xl shadow-lg border-l-4 border-[var(--color-accent)]">
              <h3 className="text-sm font-semibold text-[var(--color-primary-active)] mb-2">
                🏆 Produto Top
              </h3>
              ...
              <p className="text-sm text-[var(--color-dark)] mt-2">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <div className="space-y-2">
                {recommendation.peakDays.map((day) => (
                  <div
                    key={day.day}
                    className="flex justify-between items-center p-3 bg-[var(--color-primary-lighter)] rounded-lg"
                  >
          ...
          {/* Insights da IA */}
          <div className="bg-gradient-to-br from-[var(--color-primary-lighter)] to-[var(--color-primary-light)] p-8 rounded-xl shadow-lg border-l-4 border-[var(--color-primary)]">
            <h2 className="text-2xl font-bold text-[var(--color-primary-active)] mb-4 flex items-center gap-2">
