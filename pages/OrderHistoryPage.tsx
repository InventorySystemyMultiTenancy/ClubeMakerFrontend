  ...
  return (
    <div className="container mx-auto px-4 py-6 min-h-screen bg-stone-100">
      ...
      <div className="bg-white rounded-xl shadow-md p-4 mb-6 flex flex-wrap gap-4 items-end">
        ...
        <button
          onClick={fetchOrders}
          className="bg-[var(--color-primary)] text-white font-bold py-2 px-4 rounded-lg hover:bg-[var(--color-primary-active)] transition-colors shadow-md"
        >
          Filtrar
        </button>
        <button
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20">
          <div className="animate-spin rounded-full h-16 w-16 border-4 border-[var(--color-primary-light)] border-t-[var(--color-primary)] mb-4"></div>
        ...
        <div className="space-y-6">
          {filteredOrders.map((order) => (
            <div
              key={order.id}
              className="bg-white rounded-xl shadow-md p-6 border-l-4 border-[var(--color-primary)] cursor-pointer hover:shadow-lg transition"
              onClick={() =>
