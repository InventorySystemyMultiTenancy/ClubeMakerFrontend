...
const CHART_COLORS = ["#16b12b", "#0057c8", "#ffd900", "#e51b23"];
  ...
  if (!senhaCorreta) {
    return (
      <div className="max-w-md mx-auto mt-16 p-6 bg-white rounded-xl shadow flex flex-col items-center">
        ...
        />
        <button
          className="bg-[var(--color-primary-active)] text-white font-semibold px-6 py-2 rounded-lg hover:bg-[var(--color-primary-active)] mt-2"
          onClick={() => {
            if (senhaExtra === SENHA_ESPECIAL) {
              setSenhaCorreta(true);
              setSenhaErro("");
    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                ...
                const html = `
                  ...
                  <head>
                    ...
                    <style>
                      ...
                      h2 { color: #16b12b; margin-bottom: 24px; }
                      ...
                      th { background: #16b12b; color: #fff; font-size: 16px; }
                      tr:nth-child(even) { background: #f0fdf4; }
                      tr:nth-child(odd) { background: #fff; }
                      td { font-size: 15px; color: #334155; }
                      .estoque-baixo { color: #e51b23; font-weight: bold; }
                      .sugestao { color: #0057c8; font-weight: bold; }
                    </style>
                  </head>
                  <body>
        ...
        <button
          ...
          disabled={loading}
          className="bg-[var(--color-primary-active)] text-white font-semibold px-5 py-2.5 rounded-lg hover:bg-[var(--color-primary-active)] disabled:opacity-60 disabled:cursor-not-allowed"
        >
            ...
            <div className="inline-flex rounded-lg bg-slate-100 p-1 gap-1">
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                  filterMode === "general"
                    ? "bg-[var(--color-primary-active)] text-white"
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr_auto] gap-4 items-end">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-300 px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary-light)] focus:border-[var(--color-primary)]"
              />
            </div>
