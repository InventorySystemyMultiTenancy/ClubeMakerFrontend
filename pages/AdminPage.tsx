  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-xl shadow-xl w-full max-w-md">
        <h2 className="text-xl font-bold mb-4 text-[var(--color-primary-active)]">
        ...
        >
          ...
          <button
            type="button"
            className="w-full mb-4 py-2 bg-[var(--color-primary-lighter)] text-[var(--color-primary)] rounded-lg font-bold"
            onClick={addRow}
          >
            + Adicionar Produto
          </button>
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-start sm:items-center z-50 overflow-y-auto p-2 sm:p-4">
      <div className="bg-white p-4 sm:p-8 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <h2 className="text-2xl font-bold mb-6 text-[var(--color-primary-active)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              min="0"
              className="mt-1 block w-full rounded-md border-stone-300 shadow-sm focus:border-[var(--color-accent)] focus:ring-[var(--color-accent)]"
            />
            <p className="mt-1 text-xs text-stone-500">
          ...
          <div className="flex justify-end gap-4 pt-4">
            ...
            <button
              type="submit"
              className="bg-[var(--color-primary)] text-white font-semibold py-2 px-6 rounded-lg hover:bg-[var(--color-primary-active)]"
            >
              Salvar
            </button>
          </div>
  ...
  return (
    <div className="container mx-auto p-2 sm:p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h1 className="text-4xl font-bold text-[var(--color-primary-active)]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-[var(--color-primary)]">
      ...
      {showAnalysis && (
        <div className="bg-gradient-to-r from-[var(--color-primary-lighter)] to-[var(--color-primary-light)] p-6 rounded-xl shadow-lg mb-6 border border-[var(--color-primary-light)]">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold text-[var(--color-primary-active)] flex items-center gap-2">
              ...
              >
                ...
                <td className="px-2 sm:px-4 py-2 whitespace-nowrap">
                  ...
                  {product.minStock !== undefined &&
                    product.stock !== undefined &&
                    product.stock < product.minStock && (
                      <span className="ml-1 text-[10px] sm:text-xs text-[var(--color-primary)] font-bold animate-pulse">
                        Estoque baixo!
                      </span>
                    )}
                </td>
                <td className="px-2 sm:px-4 py-2 whitespace-nowrap text-right text-xs sm:text-sm font-medium">
                  <button
                    ...
                    className="text-[var(--color-primary)] hover:text-[var(--color-primary-active)] mr-2 sm:mr-4"
                  >
                    Editar
                  </button>
                  <button
      ...
      <div className="mt-16 bg-white rounded-2xl shadow-lg px-6 py-8 mb-8">
        ...
        <div className="flex flex-wrap gap-4 mb-6 items-end">
          ...
          <button
            className="bg-[var(--color-primary)] text-white px-5 py-2 rounded-lg hover:bg-[var(--color-primary-active)] font-semibold"
            onClick={() =>
              loadStockMovements(
